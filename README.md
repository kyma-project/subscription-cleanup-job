...
3. Set the environmental variables:
   ...
   - **APP_MARKET** - required for some restricted markets patching, such as specific Azure client creation for sovereign clouds (optional, possible values: `global`/`chinese`/`ns2`, default: `global`)
4. Run the job: `./main`.
